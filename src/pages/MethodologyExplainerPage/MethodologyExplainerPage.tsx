...
function TreemapSection({ onNavigate }: TreemapSectionProps) {
  ...
  // Categories are laid out in rows of 3, each cell 143×143px, 2px gaps.
  // Rows with fewer than 3 cats still take the same row height.
