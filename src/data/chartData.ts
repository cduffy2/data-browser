...
export const chartDataSets: Record<string, ChartDataSet | StackedChartDataSet> = {
  'any-child-no-fever-cough-care': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 38, label: '38%' },
      { segment: 'U2.1', value: 52, label: '52%' },
      { segment: 'U4', value: 61, label: '61%' },
      { segment: 'R2', value: 42, label: '42%' },
      { segment: 'R3.2', value: 58, label: '58%' },
      { segment: 'R3.1', value: 64, label: '64%' },
  ...
  'no-pnc-newborn': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 52, label: '52%' },
      { segment: 'U2.1', value: 41, label: '41%' },
  ...
  'pregnancy-ends-stillbirth': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 8, label: '8%' },
      { segment: 'U2.1', value: 12, label: '12%' },
      { segment: 'U4', value: 15, label: '15%' },
      { segment: 'R2', value: 9, label: '9%' },
      { segment: 'R3.2', value: 14, label: '14%' },
  ...
  'death-child-5yrs': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 28, label: '28%' },
      { segment: 'U2.1', value: 35, label: '35%' },
      { segment: 'U4', value: 42, label: '42%' },
      { segment: 'R2', value: 31, label: '31%' },
      { segment: 'R3.2', value: 39, label: '39%' },
  ...
  'cough-2-weeks-last': {
    ...
    data: [
      ...
      { segment: 'R3.1', value: 43, label: '43%' },
  ...
  'death-child-1yr': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 18, label: '18%' },
      { segment: 'U2.1', value: 24, label: '24%' },
      { segment: 'U4', value: 31, label: '31%' },
      { segment: 'R2', value: 20, label: '20%' },
      { segment: 'R3.2', value: 27, label: '27%' },
      { segment: 'R3.1', value: 33, label: '33%' },
  ...
  'diarrhea-2-weeks-last': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 22, label: '22%' },
      { segment: 'U2.1', value: 29, label: '29%' },
  ...
  'fever-2-weeks-last': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 26, label: '26%' },
      { segment: 'U2.1', value: 33, label: '33%' },
      { segment: 'U4', value: 40, label: '40%' },
      { segment: 'R2', value: 28, label: '28%' },
      { segment: 'R3.2', value: 36, label: '36%' },
  ...
  'low-birth-weight-last': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 11, label: '11%' },
      { segment: 'U2.1', value: 15, label: '15%' },
      { segment: 'U4', value: 19, label: '19%' },
      { segment: 'R2', value: 12, label: '12%' },
      { segment: 'R3.2', value: 17, label: '17%' },
  ...
  'no-routine-vaccination': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 11, label: '11%' },
      { segment: 'U2.1', value: 16, label: '16%' },
  ...
  'number-not-immunized-mmr': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 14, label: '14%' },
      { segment: 'U2.1', value: 19, label: '19%' },
  ...
  'vaccination-documentation': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 68, label: '68%' },
      { segment: 'U2.1', value: 62, label: '62%' },
  ...
  'zero-dose-child': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 10, label: '10%' },
      { segment: 'U2.1', value: 15, label: '15%' },
      { segment: 'U4', value: 21, label: '21%' },
      { segment: 'R2', value: 11, label: '11%' },
      { segment: 'R3.2', value: 17, label: '17%' },
      { segment: 'R3.1', value: 23, label: '23%' },
  ...
  'less-than-4-anc-visits-last': {
    ...
    data: [
      { segment: 'U1', value: 25, label: '25%' },
      { segment: 'U2.2', value: 32, label: '32%' },
      { segment: 'U2.1', value: 41, label: '41%' },
  ...
  'no-anc-1st-trimester-last': {
    ...
    data: [
      { segment: 'U1', value: 30, label: '30%' },
      { segment: 'U2.2', value: 38, label: '38%' },
      { segment: 'U2.1', value: 47, label: '47%' },
      { segment: 'U4', value: 58, label: '58%' },
      { segment: 'R2', value: 41, label: '41%' },
      { segment: 'R3.2', value: 52, label: '52%' },
      { segment: 'R3.1', value: 61, label: '61%' },
  ...
  'received-pnc': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 65, label: '65%' },
      { segment: 'U2.1', value: 58, label: '58%' },
      { segment: 'U4', value: 48, label: '48%' },
  ...
  'any-child-not-immediately-breastfed': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 24, label: '24%' },
      { segment: 'U2.1', value: 32, label: '32%' },
      { segment: 'U4', value: 41, label: '41%' },
      { segment: 'R2', value: 27, label: '27%' },
      { segment: 'R3.2', value: 36, label: '36%' },
      { segment: 'R3.1', value: 44, label: '44%' },
      { segment: 'R4', value: 52, label: '52%' }
    ],
    medianLine: 32
  },
  'child-not-exclusively-breastfed': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 42, label: '42%' },
      { segment: 'U2.1', value: 51, label: '51%' },
      { segment: 'U4', value: 62, label: '62%' },
      { segment: 'R2', value: 45, label: '45%' },
      { segment: 'R3.2', value: 56, label: '56%' },
      { segment: 'R3.1', value: 65, label: '65%' },
  ...
  'stunted-child': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 28, label: '28%' },
      { segment: 'U2.1', value: 36, label: '36%' },
  ...
  'wasted-child': {
    ...
    data: [
      { segment: 'U1', value: 8, label: '8%' },
      { segment: 'U2.2', value: 12, label: '12%' },
      { segment: 'U2.1', value: 16, label: '16%' },
      { segment: 'U4', value: 22, label: '22%' },
  ...
  'woman-underweight': {
    ...
    data: [
      { segment: 'U1', value: 12, label: '12%' },
      { segment: 'U2.2', value: 16, label: '16%' },
      { segment: 'U2.1', value: 21, label: '21%' },
  ...
  'never-tested-hiv': {
    ...
    data: [
      { segment: 'U1', value: 25, label: '25%' },
      { segment: 'U2.2', value: 32, label: '32%' },
      { segment: 'U2.1', value: 42, label: '42%' },
  ...
  'never-used-modern-fp-method': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 35, label: '35%' },
      { segment: 'U2.1', value: 45, label: '45%' },
      { segment: 'U4', value: 57, label: '57%' },
      { segment: 'R2', value: 38, label: '38%' },
      { segment: 'R3.2', value: 50, label: '50%' },
  ...
  'non-use-modern-fp-method': {
    ...
    data: [
      { segment: 'U1', value: 32, label: '32%' },
      { segment: 'U2.2', value: 39, label: '39%' },
      { segment: 'U2.1', value: 48, label: '48%' },
      { segment: 'U4', value: 59, label: '59%' },
      { segment: 'R2', value: 42, label: '42%' },
      { segment: 'R3.2', value: 53, label: '53%' },
      { segment: 'R3.1', value: 62, label: '62%' },
  ...
  'sti-last-12-months': {
    ...
    data: [
      { segment: 'U1', value: 5, label: '5%' },
      { segment: 'U2.2', value: 7, label: '7%' },
      { segment: 'U2.1', value: 10, label: '10%' },
  ...
  'any-media-exposure': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 72, label: '72%' },
      { segment: 'U2.1', value: 65, label: '65%' },
      { segment: 'U4', value: 58, label: '58%' },
  ...
  'female-circumcision': {
    ...
    data: [
      { segment: 'U1', value: 12, label: '12%' },
      { segment: 'U2.2', value: 18, label: '18%' },
      { segment: 'U2.1', value: 25, label: '25%' },
  ...
  'media-exposure-internet': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 52, label: '52%' },
      { segment: 'U2.1', value: 38, label: '38%' },
      { segment: 'U4', value: 25, label: '25%' },
  ...
  'age-at-first-birth': {
    ...
    data: [
      ...
      { segment: 'U2.2', under20: 32, age20to29: 52, age30plus: 16 },
      { segment: 'U2.1', under20: 38, age20to29: 48, age30plus: 14 },
      { segment: 'U4', under20: 45, age20to29: 44, age30plus: 11 },
      { segment: 'R2', under20: 42, age20to29: 46, age30plus: 12 },
      { segment: 'R3.2', under20: 48, age20to29: 42, age30plus: 10 },
      { segment: 'R3.1', under20: 52, age20to29: 40, age30plus: 8 },
  ...
  'hw-visit-last-yr': {
    ...
    data: [
      ...
      { segment: 'U4', value: 28, label: '28%' },
      { segment: 'R2', value: 35, label: '35%' },
      { segment: 'R3.2', value: 25, label: '25%' },
  ...
  'access-problem-travel-alone': {
    ...
    data: [
      { segment: 'U1', value: 15, label: '15%' },
      { segment: 'U2.2', value: 22, label: '22%' },
      { segment: 'U2.1', value: 28, label: '28%' },
  ...
  'preferred-birth-interval': {
    ...
    data: [
      ...
      { segment: 'U2.2', lessThan2: 10, twoToFour: 32, fivePlus: 20, noMore: 30, dontKnow: 8 },
      { segment: 'U2.1', lessThan2: 12, twoToFour: 30, fivePlus: 18, noMore: 32, dontKnow: 8 },
      ...
      { segment: 'R3.2', lessThan2: 18, twoToFour: 25, fivePlus: 14, noMore: 33, dontKnow: 10 },
      { segment: 'R3.1', lessThan2: 20, twoToFour: 24, fivePlus: 12, noMore: 32, dontKnow: 12 },
  ...
  'partner-opposition-fp': {
    ...
    data: [
      ...
      { segment: 'U2.2', opposes: 18, notOpposes: 60, noNeed: 22 },
      { segment: 'U2.1', opposes: 25, notOpposes: 52, noNeed: 23 },
      { segment: 'U4', opposes: 32, notOpposes: 45, noNeed: 23 },
      { segment: 'R2', opposes: 28, notOpposes: 48, noNeed: 24 },
      { segment: 'R3.2', opposes: 35, notOpposes: 42, noNeed: 23 },
      { segment: 'R3.1', opposes: 40, notOpposes: 38, noNeed: 22 },
  ...
  'decision-maker-fp': {
    ...
    data: [
      ...
      { segment: 'U2.2', respondent: 18, partner: 12, joint: 45, pregnant: 6, other: 3, noPartner: 16 },
      { segment: 'U2.1', respondent: 15, partner: 18, joint: 40, pregnant: 7, other: 4, noPartner: 16 },
      ...
      { segment: 'R3.2', respondent: 10, partner: 25, joint: 35, pregnant: 8, other: 6, noPartner: 16 },
      { segment: 'R3.1', respondent: 8, partner: 28, joint: 32, pregnant: 9, other: 7, noPartner: 16 },
  ...
  'decision-maker-hh-purchases': {
    ...
    data: [
      ...
      { segment: 'U2.2', respondent: 14, partner: 20, joint: 42, someoneElse: 6, other: 3, noPartner: 15 },
      { segment: 'U2.1', respondent: 12, partner: 25, joint: 38, someoneElse: 7, other: 4, noPartner: 14 },
      ...
      { segment: 'R3.2', respondent: 8, partner: 32, joint: 32, someoneElse: 10, other: 5, noPartner: 13 },
      { segment: 'R3.1', respondent: 6, partner: 35, joint: 28, someoneElse: 12, other: 6, noPartner: 13 },
  ...
  'decision-maker-own-income': {
    ...
    data: [
      ...
      { segment: 'U2.2', respondent: 30, partner: 12, joint: 38, someoneElse: 4, other: 2, noPartner: 14 },
      { segment: 'U2.1', respondent: 25, partner: 16, joint: 36, someoneElse: 5, other: 3, noPartner: 15 },
      ...
      { segment: 'R3.2', respondent: 18, partner: 22, joint: 32, someoneElse: 8, other: 5, noPartner: 15 },
      { segment: 'R3.1', respondent: 15, partner: 25, joint: 30, someoneElse: 10, other: 5, noPartner: 15 },
  ...
  'sex-head-of-hh': {
    ...
    data: [
      ...
      { segment: 'U2.2', male: 72, female: 28 },
      { segment: 'U2.1', male: 75, female: 25 },
      { segment: 'U4', male: 78, female: 22 },
      { segment: 'R2', male: 76, female: 24 },
      { segment: 'R3.2', male: 80, female: 20 },
      { segment: 'R3.1', male: 82, female: 18 },
  ...
  'bank-account-woman': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 48, label: '48%' },
      { segment: 'U2.1', value: 35, label: '35%' },
      { segment: 'U4', value: 22, label: '22%' },
      { segment: 'R2', value: 28, label: '28%' },
      { segment: 'R3.2', value: 18, label: '18%' },
  ...
  'hh-clean-cooking-fuel': {
    ...
    data: [
      { segment: 'U1', value: 72, label: '72%' },
      { segment: 'U2.2', value: 58, label: '58%' },
      { segment: 'U2.1', value: 42, label: '42%' },
      { segment: 'U4', value: 28, label: '28%' },
  ...
  'hh-electricity': {
    ...
    data: [
      ...
      { segment: 'U2.2', value: 88, label: '88%' },
      { segment: 'U2.1', value: 78, label: '78%' },
  ...
  'hh-member-without-insurance': {
    ...
    data: [
      { segment: 'U1', value: 35, label: '35%' },
      { segment: 'U2.2', value: 45, label: '45%' },
      { segment: 'U2.1', value: 55, label: '55%' },
      { segment: 'U4', value: 68, label: '68%' },
      { segment: 'R2', value: 62, label: '62%' },
      { segment: 'R3.2', value: 72, label: '72%' },
      { segment: 'R3.1', value: 78, label: '78%' },
  ...
  'hh-slum-residence': {
    ...
    data: [
      ...
      { segment: 'U2.2', rural: 0, urbanSlum: 28, urbanNonSlum: 72 },
      { segment: 'U2.1', rural: 0, urbanSlum: 42, urbanNonSlum: 58 },
  ...
  'hh-water-source-interrupted': {
    ...
    data: [
      ...
      { segment: 'U2.2', yes: 25, no: 58, notPiped: 17 },
      { segment: 'U2.1', yes: 28, no: 45, notPiped: 27 },
      { segment: 'U4', yes: 32, no: 32, notPiped: 36 },
      { segment: 'R2', yes: 22, no: 38, notPiped: 40 },
      { segment: 'R3.2', yes: 18, no: 25, notPiped: 57 },
      { segment: 'R3.1', yes: 15, no: 18, notPiped: 67 },
