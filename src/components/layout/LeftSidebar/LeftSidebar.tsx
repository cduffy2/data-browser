...
export type Page = 'kenya-overview' | 'data-browser' | 'rural-4' | 'walk-in-her-shoes' | 'not-found' | 'compare-segments' | 'segmentations' | 'assistant' | 'prevalence-map' | 'welcome' | 'news' | 'news-detail' | 'resources' | 'contact' | 'article-detail' | 'resources-filtered' | 'loading' | 'domain-detail' | 'methodology-explainer' | 'how-pathways-data' | 'guide-article';
...
const badgeImages: Record<string, { src: string; width: number }> = {
  ...
  '2.1': { src: Badge21, width: 32 },
  '2.2': { src: Badge22, width: 32 },
